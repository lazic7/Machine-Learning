...
print(df.sort_values(by=['selling_price'], ascending=True).head(1)[['name','selling_price']])
print(df.sort_values(by=['selling_price'], ascending=True).tail(1)[['name','selling_price']])



print(df.sort_values(by=['km_driven'], ascending=True).head(1)[['name','selling_price']])
print(df.sort_values(by=['km_driven'], ascending=True).tail(1)[['name','selling_price']])
